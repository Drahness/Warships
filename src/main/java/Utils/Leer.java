...
public class Leer {
	...
	public static int leerEntero(String mensaje, int limite) {
		...
		if (!(n < limite && n > -1)) {
			System.out.println(ConsoleColors.printError("\nDeus posar un numero correcte maxim ="+ limite));
	...
	public static int leerEntero(String mensaje, int minimo, int maximo) {
		...
		if (!(n > minimo-1 && n < maximo+1)) {
			System.out.println(String.format(ConsoleColors.printError("\nTienes que elegir un numero entre %d y %d"),minimo,maximo));
